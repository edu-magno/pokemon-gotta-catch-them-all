...
///
/// [voidSucessful] is a sucessful state when you need emit 
/// a succesful state but without values
@freezed
abstract class CommonState<Failed, Success>
  ...
  const factory CommonState.voidSucessful() = CommonStateVoidSucessful;
}
